...
def main():
    ...
    print(f"API Key Name length: {len(config.coinbase_api_key_name) if config.coinbase_api_key_name else 0}")
    print(f"Private Key length: {len(config.coinbase_api_private_key) if config.coinbase_api_private_key else 0}")
