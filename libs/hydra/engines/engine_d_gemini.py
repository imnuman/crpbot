...
class EngineD_Gemini(BaseEngine):
    ...
    def make_trade_decision(
        ...
        my_rank = next((r for r in tournament_summary["rankings"] if r["gladiator"] == "D"), None)
...
"""
        ...
        return f"""You are Gladiator D, an INDEPENDENT trader specializing in SYNTHESIS.
...
- Your P&L determines your tournament rank
- Every 24 hours: Weights adjust based on performance (no killing)
- Every 4 days: Top 2 gladiators "breed" (combine strategies)
- Winners teach losers their successful patterns
