...
class EngineA_DeepSeek(BaseEngine):
    ...
    def make_trade_decision(
        ...
        my_rank = next((r for r in tournament_summary["rankings"] if r["gladiator"] == "A"), None)
...
"""
        ...
        return f"""You are Gladiator A, an INDEPENDENT trader specializing in STRUCTURAL edges.

TOURNAMENT COMPETITION:
- You are COMPETING against 3 other engines (B, C, D)
...
{{
  ...
  "reasoning": "Why you chose this direction (mention regime alignment)"
    ...
    def _build_system_prompt(self, asset_type: str) -> str:
        """Build system prompt for strategy generation (legacy method)."""
